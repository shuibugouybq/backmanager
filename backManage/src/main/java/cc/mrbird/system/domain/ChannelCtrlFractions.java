...
@Table(name = "ft_channel_ctrl_fractions")
public class ChannelCtrlFractions {
    /**
     ...
     * 通道时间
     */
    @Column(name = "CHANNEL_TRANS_DATE")
    private Date channelTransDate;
     ...
     * 获取通道时间
     *
     * @return CHANNEL_TRANS_DATE - 通道时间
     */
    public Date getChannelTransDate() {
     ...
     * 设置通道时间
     *
     * @param channelTransDate 通道时间
     */
    public void setChannelTransDate(Date channelTransDate) {
